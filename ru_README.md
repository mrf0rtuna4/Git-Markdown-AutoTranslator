...
- `DEBUG`: Установите `True`, чтобы включить подробное протоколирование процесса перевода. Это полезно для устранения неполадок, но может генерировать подробный вывод.
